        ...
        <nav id="mainNavbar" class="navbar navbar-vertical navbar-expand-lg scrollbar buca-color navbar-dark">
            ...
            <div class="container-fluid">
                ...
                <a class="navbar-brand" href="index.html.htm">
                    ...
                    <img src="{{asset('assets/favicon/buca.jpg')}}" class="navbar-brand-img logo-dark logo-large" alt="..." width="70" height="70"> <span style="color:white">BUCA VOYAGE</span>
                </a>
                ...
                <div class="d-flex align-items-center ms-auto me-n1 me-lg-n2">
                    ...
                    <div class="dropdown">
                        <a href="javascript: void(0);" class="dropdown-toggle no-arrow d-flex align-items-center justify-content-center bg-white rounded-circle shadow-sm mx-1 mx-lg-2 w-40px h-40px" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-bs-offset="0,0">
                            <span class="avatar avatar-circle avatar-xxs"><img class="avatar-img" src="{{asset('assets/svg/us.svg')}}" alt="..." width="18" height="18"></span>
                        </a>

                        <ul class="dropdown-menu dropdown-menu-end">
                            <li>
                                <h6 class="dropdown-header text-uppercase">Selectionnez un langage</h6>
                            </li>
                            <li>
                                <a href="javascript: void(0);" class="dropdown-item active">
                                    <span class="avatar avatar-circle avatar-xxs"><img class="avatar-img" src="{{asset('assets/svg/us.svg')}}" alt="..." width="18" height="18"></span><span class="text-truncate ms-2">English (US)</span>
                                </a>
                            </li>
                            <li>
                                <a href="javascript: void(0);" class="dropdown-item">
                                    <span class="avatar avatar-circle avatar-xxs"><img class="avatar-img" src="{{asset('assets/svg/gb.svg')}}"" alt="..." width="18" height="18"></span><span class="text-truncate ms-2">English (UK)</span>
                                </a>
                            </li>
                            <li>
                                <a href="javascript: void(0);" class="dropdown-item">
                                    <span class="avatar avatar-circle avatar-xxs"><img class="avatar-img" src="{{asset('assets/svg/es.svg')}}" alt="..." width="18" height="18"></span><span class="text-truncate ms-2">Español</span>
                                </a>
                            </li>
                            <li>
                                <a href="javascript: void(0);" class="dropdown-item">
                                    <span class="avatar avatar-circle avatar-xxs"><img class="avatar-img" src="{{asset('assets/svg/fr.svg')}}" alt="..." width="18" height="18"></span><span class="text-truncate ms-2">Française</span>
                                </a>
                            </li>
                            <li>
                                <a href="javascript: void(0);" class="dropdown-item">
                                    <span class="avatar avatar-circle avatar-xxs"><img class="avatar-img" src="{{asset('assets/svg/de.svg')}}" alt="..." width="18" height="18"></span><span class="text-truncate ms-2">Deutsch</span>
                                </a>
                            </li>
                            <li>
                                <a href="javascript: void(0);" class="dropdown-item">
                                    <span class="avatar avatar-circle avatar-xxs"><img class="avatar-img" src="{{asset('assets/svg/cn.svg')}}" alt="..." width="18" height="18"></span><span class="text-truncate ms-2">中文 (繁體)</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="dropdown">
                        <a href="javascript: void(0);" class="dropdown-toggle no-arrow d-flex align-items-center justify-content-center bg-white rounded-circle shadow-sm mx-1 mx-lg-2 w-40px h-40px link-secondary" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-bs-offset="0,0">
                            <svg viewbox="0 0 24 24" height="18" width="18" xmlns="http://www.w3.org/2000/svg"><path d="M8.250 12.000 A3.750 3.750 0 1 0 15.750 12.000 A3.750 3.750 0 1 0 8.250 12.000 Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M17.119 20.301L12.529 15.711" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M15.711 12.53L20.301 17.119" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M3.699 17.119L8.289 12.529" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M11.471 15.712L6.881 20.301" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M6.881 3.7L11.471 8.289" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M8.289 11.471L3.699 6.881" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M20.301 6.881L15.711 11.471" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M12.529 8.289L17.119 3.7" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M2.250 12.000 A9.750 9.750 0 1 0 21.750 12.000 A9.750 9.750 0 1 0 2.250 12.000 Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path></svg>
                        </a>
                            ...
                            <div class="py-4 px-5">
                                <div class="row">
                                    ...
                                    <div class="col-4 d-flex justify-content-center align-items-center">
                                        <a href="javascript: void(0);" class="d-inline-block link-secondary fs-5 fw-semibold text-center p-3">
                                            <span class="avatar avatar-xs d-flex align-items-center mx-auto mb-1">
                                                <svg class="avatar-img mx-auto" viewbox="2.59 0 214.09101008 224" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><lineargradient id="a" gradienttransform="matrix(1 0 0 -1 0 264)" gradientunits="userSpaceOnUse" x1="102.4" x2="56.15" y1="218.63" y2="172.39"><stop offset=".18" stop-color="#0052cc"></stop><stop offset="1" stop-color="#2684ff"></stop></lineargradient><lineargradient id="b" x1="114.65" x2="160.81" xlink:href="#a" y1="85.77" y2="131.92"></lineargradient><path d="m214.06 105.73-96.39-96.39-9.34-9.34-72.56 72.56-33.18 33.17a8.89 8.89 0 0 0 0 12.54l66.29 66.29 39.45 39.44 72.55-72.56 1.13-1.12 32.05-32a8.87 8.87 0 0 0 0-12.59zm-105.73 39.39-33.12-33.12 33.12-33.12 33.11 33.12z" fill="#2684ff"></path><path d="m108.33 78.88a55.75 55.75 0 0 1 -.24-78.61l-72.47 72.44 39.44 39.44z" fill="url(#a)"></path><path d="m141.53 111.91-33.2 33.21a55.77 55.77 0 0 1 0 78.86l72.67-72.63z" fill="url(#b)"></path></svg>
                                            </span>
                                            JIRA
                                        </a>
                                    </div>
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCustomize" aria-labelledby="offcanvasCustomizeTitle">
                        <div class="offcanvas-body pt-7 pb-5 position-relative">
                            ...
                            <div class="text-center">
                                <img src="0e108d71de2aec22aae71d891ecabd0ec28dc2bb/8484b/assets/images/illustrations/customization-illustration.svg" alt="..." class="img-fluid w-50 mb-5" width="170" height="170">
                            ...
                            <div class="dropdown-item-text">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h4 class="mb-0">Buca Voyage</h4>
                                        <p class="card-text">BucaVoyages@gmail.com</p>
                                    </div>
                                </div>
                            </div>
